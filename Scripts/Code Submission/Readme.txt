...
but if the parameters are change it can be done on any subject. It plots scatter plots of featrues, "best features" per model
...
and trains on the first session and test on the competition data.
