...
%
% Revision 1.33  2004/09/07 21:17:52  arno
% same
%
% Revision 1.32  2004/09/07 21:17:05  arno
% remove warnings
%
% Revision 1.31  2004/09/07 21:15:46  arno
% remove uint64
%
% Revision 1.30  2004/09/07 21:12:19  arno
% debug bitand
%
% Revision 1.29  2004/09/07 21:08:15  arno
% fix reading problem
%
% Revision 1.28  2004/09/01 16:22:34  arno
% same
%
% Revision 1.27  2004/09/01 16:18:46  arno
% fix reading problem
%
% Revision 1.26  2004/08/31 21:24:37  arno
% using new biosig function
%
% Revision 1.25  2004/08/19 18:48:09  arno
% bitand for matlab 7
%
...
if ~exist('inputgui')
    error('This function requires the EEGLAB toolbox');
end;
...
if nargin < 1 
    ...
    dat = sopen(filename);
    promptstr    = { [ 'Data block range to read (default all [1 ' int2str(dat.NRec) '])' ]
                     [ 'Event channel number(s) (default:none [1-' int2str(dat.NS)  '])' ]
...
EEG.filepath        = '';
EEG.xmin            = 0; 
EEG.chanlocs        = struct('labels', cellstr(dat.Label));
...
if ~isempty(eventchans)
    ...
    warning off;
    EEG.data(eventchans,:) = bitand(uint32(round(EEG.data(eventchans,:))), 255);
    warning on;
